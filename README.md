...
Solo top-down dungeon crawler: BSP-карта, магазин, аура, бластер, бомбы. Режимы: solo, против ботов, **hotseat 1v1** (два геймпада), **сеть 1v1**.
...
4. Сервер синхронизирует бой (30 TPS), клиент предсказывает своё движение и интерполирует остальное
